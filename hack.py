...
\033[1;93m🔥╭╬──────────────────────────────────╬╮🔥
\033[0;94m  ⚡ ✯ 𝕮𝖗𝖊𝖆𝖙𝖔𝖗 ✪ Zafar Sarparah   ✬⚡
\033[0;94m  ⚡ ✯ 𝖄𝖔𝖚𝖙𝖚𝖇𝖊 ✪ Zafar Creations ✬⚡
...
jalan("\033[1;96m•◈•────────────•◈•\033[1;99mZafar\033[1;99m•◈•────────────•◈•")                        
...
jalan("\033[1;93m Welcome to Zafar Creations")
jalan("\033[1;96m•◈•──────────•◈•\033[1;96mzafarsarparah1\033[1;96m•◈•──────────•◈•")

CorrectUsername = "zafar"
CorrectPassword = "zafar"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:ZAFAR
	    time.sleep(2)
            loop = 'false'
        else:
...
def menu():
	...
	print "\033[1;32;40m[2] \033[1;33;42mUpdate Zafar"																														
...
def brute():
    ...
    try:
        ...
        try:
            ...
            passw = raw_input('\x1b[1;91m[+] \x1b[1;92mWordlist \x1b[1;97mext(pa.txt) \x1b[1;91m: \x1b[1;97m')
            total = open(passw, 'r')
